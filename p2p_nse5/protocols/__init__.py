...
the three different protocols used in this project:
  ...
  * Module :mod:`protocols.nse <p2p_nse5.protocols.nse>` contains a
    collection of convenience features that are used by the NSE scheduler
    and the respective handlers (it doesn't directly contain a protocol)
